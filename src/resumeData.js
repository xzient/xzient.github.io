...
<<<<<<< HEAD
  ...
  aboutme2:
    "When it comes to computer science, I have mainly worked with Java and Python. Within Python, I have used different libraries such as Pandas, PyTorch, NLTK, Pyplot, OpenCV, etc. I have used other libraries for computer vision, machine learning, and data analysis. I have done both front end and back end programming. For front end, I have mostly focused on creating simple Android apps with Android Studio. I also have an interest for functional languages. While studying at the University of Maryland, I was exposed to OCaml, which really helped me admire functional programming.",
=======
    "Hello. My name is Xavier. After completing my bachelor’s degrees in computer science and applied linguistics at the University of Maryland, I have decided to pursue a master’s degree in Computer Science with a focus on AI at Laval University in Quebec City. ",
  aboutme2:
...
>>>>>>> source
  ...
  skillsDescription:
<<<<<<< HEAD
    "Besides the skills shown below, I have some experience with R and SQL. I used these two for data analysis while doing research. I also know LaTeX which I constantly use for writing reports and homework at school. Lastly, I have used Praat and Elan for phonological analysis in linguistics.",
=======
